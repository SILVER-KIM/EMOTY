...
public class ExListAdapter extends BaseExpandableListAdapter {
    ...
    public ExListAdapter(Context context, int groupLay, int chlidLay, ArrayList<MyGroup> DataList){
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        TextView childName = (TextView)convertView.findViewById(R.id.friend_name);
